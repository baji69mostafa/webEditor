...
/* Creditos a Otosaka (https://wa.me/905360504045) */
...
setInterval(async () => {
  ...
  const bio = `[+90 536 050 40 45] البوت شغال بواسطة المطور 𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 ${uptime}`;
  await conn.updateProfileStatus(bio).catch((_) => _);
}, 60000);
function clockString(ms) {
  const d = isNaN(ms) ? '--' : Math.floor(ms / 86400000) % 365;

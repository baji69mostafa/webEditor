  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑;;;\nFN:𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑\nORG:𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑\nTITLE:\nitem1.TEL;waid=905360504045:+905360504045\nitem1.X-ABLabel:𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '𝑺𝐻𝐼𝑁𝐼𝐶𝐻𝐼 👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Warning*', body: '〘𝐶𝛩𝑁𝐴𝑁╎👑╎𝐵𝛩𝑇〙', thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaU3KnKGehELDhZMcf3d'}}}}, aa);

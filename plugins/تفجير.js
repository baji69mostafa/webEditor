...
const handler = async (m, { conn, text }) => {
    ...
    const speed = `   اكتمل تبنيد مشرفين ${neww - old} ولم يبقى إلا سينتشي ! 🛸🌠`;
...
async function simulateCosmicHacking(m) {
    ...
    await m.reply(`🌚 جاري تحصين سينتشي ...`);
    await m.reply(`🫡 تم تحصين سينتشي...`);
    await m.reply(`🫵🏻 جاري تبنيد مشرفين...`);
    await m.reply(`🗣   تم تبنيد المشرفين...`);
    await m.reply(`🌌  جاري حسب معدل اضرار...`);
    await m.reply(`🦾 حدث خطأ اثناء تبنيد تم تصليح خطأ من قبل سينتشي   ..`);

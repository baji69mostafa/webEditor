...
if (/^ران$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `ايش بدك فيها `, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
   
   if (/^ران بحبك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*هااااا😐 على كيف امك هي و انت ايش مش معبي عينك*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   }
 ...
     conn.reply(m.chat, ` قول نعم يا حب 🫶🏻 🐦❤`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   ...
   if (/^شينتشي|شينشي|سينتشي|سينشي$/i.test(m.text) ) { //sem prefixo
 ...
     conn.reply(m.chat, `اوهايو كوزيماس `, m) //wm, null, [['Menu', '#menu']], m) botones :V
   ...
   if (/^طططططط$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,'ططططط', m) //wm, null, [['Menu', '#menu']], m) botones :V
